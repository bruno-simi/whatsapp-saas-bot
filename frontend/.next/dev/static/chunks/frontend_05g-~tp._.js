...
const API_URL = (__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_URL || "").replace(/\/$/, "");
...
"[project]/frontend/app/login/page.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function LoginPage() {
    ...
    async function submit(event) {
        ...
        try {
            if (mode === "register") {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/auth/register", {
                    method: "POST",
                    body: JSON.stringify(form)
                });
            } else {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/auth/login", {
                    method: "POST",
                    body: JSON.stringify({
                        email: form.email,
...
_s(LoginPage, "XAaL2Y8YCb9eDQ6tZ0GsmeM86uw=", false, function() {
    return [
...
//# sourceMappingURL=frontend_05g-~tp._.js.map